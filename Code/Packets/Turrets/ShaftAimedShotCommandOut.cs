...
{
    /// <summary>
    /// Packet for Shaft aimed shot command out (time, staticHitPoint, targets, targetHitPoints, targetIncarnation, targetPosition, hitPointWorld).
    /// </summary>
    public class ShaftAimedShotCommandOut : AbstractPacket
    {
        public static int Id { get; } = 1632423559;
        public override string Description => "Shaft aimed shot command out (time, staticHitPoint, targets, targetHitPoints, targetIncarnation, targetPosition, hitPointWorld)";
