...
namespace ProtankiNetworking.Packets.Turrets
{
    ...
    {
        public static int Id { get; } = 259979915;
        public override string Description => "Thunder hit target out (time, relativeHitPoint, target, incarnation, targetPosition, hitPointWorld)";
